...
function enqueue_avl_forms_js() {
    wp_enqueue_script('avl-forms', plugins_url('avl-forms.js', __FILE__), array('jquery'), '1.1.0', true);
}

// Call the CSS code
function enqueue_avl_forms_styles() {
    wp_enqueue_style('avl-forms', plugins_url('avl-forms.css', __FILE__), array(), '1.1.0');
}
