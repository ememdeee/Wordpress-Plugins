...
<div class="tf-main-wrapper single-page-apart tf-apartment-wrap tf-apartment tourfic-addon tourfic-addon-apartment">
        ...
        <div class="tf-container">
            ...
            <div class="tf-title-wrap">
                <div class="tf-title-left">
                    <h1><?php the_title(); ?></h1>
                    <p><?php echo ! empty( $meta['description_title'] ) ? esc_html( $meta['description_title'] ) : ''; ?></p>
    ...
    <div class="tf-apt-hero-section">
        <div class="tf-container">
            <div class="tf-apartment-content-wrapper flex-col-sm tourfic-addon">
                <!-- Images -->
                <div class="tf-apt-hero-wrapper tf-apartment-left">
                    <!-- Custom Slider, original removed -->
                    <?php 
                        $post_id = esc_attr( get_the_ID() );

                        // Check if the post ID is 3425
                        if ( $post_id == 3425 ) {
                            echo '<!-- Private pool -->';
                            echo do_shortcode('[elementor-template id="6783"]');
                        }

                        // Check if the post ID is 3559
                        if ( $post_id == 3559 ) {
                            echo '<!-- 4 bedroom -->';
                            echo do_shortcode('[elementor-template id="6764"]');
                        }
                    ?>
                    <div class="customPricing villa">
                        <span class="pricingData villa">
                            <span class="discount">
                            <?php
                    		$apartment_min_price = get_apartment_min_max_price( get_the_ID() );
							$apartment_min_main_price = $apartment_min_price["min"];
                            echo wp_kses_post(wc_price( $apartment_min_main_price + 1000 ));
							?>
                            </span>
                            <span class="real">
                            <?php
                ...
                <div class="tf-apartment-right">
                    <div class="apartment-booking-form" id="book">
    ...
    // Deleted this FAQ Section
    
    if ( ! empty( $meta['terms_and_conditions'] ) ) : ?>
