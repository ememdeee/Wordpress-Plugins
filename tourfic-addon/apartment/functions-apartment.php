...
if ( ! function_exists( 'tf_apartment_search_form_horizontal' ) ) {
	function tf_apartment_search_form_horizontal( $classes, $title, $subtitle, $advanced, $design ) {
						...
						<div class="tf_destination_fields">
							<label class="tf_label_location">
								...
								<div class="tf_form_inners tf_form-inner">
									...
									<input type="text" required="" name="place-name" id="tf-apartment-location" class="" placeholder="<?php esc_html_e( 'Enter Villa Type', 'tourfic' ); ?>" value="">
		...
		<?php } else{ ?>
        <form class="tf_booking-widget customSearchForm <?php echo esc_attr( $classes ); ?>" id="tf_apartment_booking" method="get" autocomplete="off" action="<?php echo esc_url( tf_booking_search_action() ); ?>">
            <div class="tf_homepage-booking">
                    ...
                    <div class="tf_input-inner">
                        <div class="tf_form-row">
                            <label class="tf_label-row">
                                <span class="tf-label"><?php esc_html_e( 'Location', 'tourfic' ); ?>:</span>
								<!-- custom select box, original text removed -->
								<div class="tf_form-inner custom-select">
									<div class="tf-search-form-field-icon title">Villa Type</div>
									<select name="place-name" id="tf-apartment-location" class="" required>
										<option value="" disabled selected>Select Villa Type</option>
										<option value="Private Pool Villa">Private Pool Villa</option>
										<option value="4 Bedrooms Villa">4 Bedrooms Villa</option>
									</select>
									<input type="hidden" name="place" class="tf-place-input">
								</div>
                            </label>
                        ...
                        <div class="tf_form-row">
                            <label class="tf_label-row">
                                ...
                                <div class="tf_form-inner">
                                    <span class="tf-search-form-field-icon title">Check-in - Check-out</span>
				...
				<div class="tf_selectperson-wrap">
                    <div class="tf_form-inner">
						<span class="tf_person-icon tf-search-form-field-icon title">Guests</span>
						<div class="tf_input-inner">
                    ...
                    <div class="tf_acrselection-wrap">
                        <div class="tf_acrselection-inner">
                            <div class="tf_acrselection">
                                <div class="acr-label"><?php esc_html_e( 'Adult', 'tourfic' ); ?></div>
                                <div class="acr-select">
                                    <div class="acr-dec" onclick="decrease('adults', 'adults-text')">-</div>
                                    <input type="number" name="adults" id="adults" min="1" value="1"/>
                                    <div class="acr-inc" onclick="increase('adults', 'adults-text')">+</div>
                                </div>
                            </div>
							<?php if ( empty( $disable_apartment_child_search ) ): ?>
                                <div class="tf_acrselection">
                                    <div class="acr-label"><?php esc_html_e( 'Children', 'tourfic' ); ?></div>
                                    <div class="acr-select">
                                        <div class="acr-dec" onclick="decrease('children', 'child-text')">-</div>
                                        <input type="number" name="children" id="children" min="0" value="0"/>
                                        <div class="acr-inc" onclick="increase('children', 'child-text')">+</div>
                                    </div>
                                </div>
							<?php endif; ?>
							<?php if ( empty( $disable_apartment_infant_search ) ): ?>
                                <div class="tf_acrselection">
                                    <div class="acr-label"><?php esc_html_e( 'Infant', 'tourfic' ); ?></div>
                                    <div class="acr-select">
                                        <div class="acr-dec" onclick="decrease('infant', 'infant-text')">-</div>
                                        <input type="number" name="infant" id="infant" min="0" value="0"/>
                                        <div class="acr-inc" onclick="increase('infant', 'infant-text')">+</div>
                                    </div>
                                </div>
							<?php endif; ?>
                        </div>
                ...
                <div class="tf_submitBtn-wrap" onclick="searchFormSubmit()">
                    <input type="hidden" name="type" value="tf_apartment" class="tf-post-type"/>
                    <button class="" type="submit"><?php esc_html_e( 'Get More Information', 'tourfic' ); ?></button>
                </div>
            </div>
...
if ( ! function_exists( 'tf_apartment_single_booking_form' ) ) {
	function tf_apartment_single_booking_form( $comments, $disable_review_sec ) {
		...
		<?php }else{ ?>
        <!-- Start Booking widget Tourfic Addon -->
        <!-- <form id="tf-apartment-booking" class="tf-apartment-side-booking tf-apartment-design-one-form" method="get" autocomplete="off"> -->
        <div id="tf-apartment-booking" class="tf-apartment-side-booking tf-apartment-design-one-form">
			...
			<?php if ( ( $tf_booking_type == 2 && $tf_hide_booking_form !== '1' ) || $tf_booking_type == 1 ) : ?>
                <div class="tf-apartment-form-fields">
					<!-- Custom Form -->
					<?php echo do_shortcode('[elementor-template id="3653"]'); ?>

                    <div class="tf_booking-dates inputFieldTourfic tours-check-in-out input">
                    ...
                    <div class="tf_form-row tf-apartment-guest-row inputFieldTourfic">
                        <label class="tf_label-row">
                            <span class="tf-label"><?php esc_html_e( 'Guests', 'tourfic' ); ?></span>
                            <div class="tf_form-inner">
                                <div class="tf_selectperson-wrap">
					...
					<div class="inputFieldContainer" id="textAreaClone_container">
						<label for="form-field-bookingMessage-clone" class="elementor-field-label">Your Message (Optional)</label>
						<textarea class="" id="form-field-bookingMessage-clone" rows="2" placeholder="Your Message (Optional)" spellcheck="false" style="background: white;"></textarea>
					</div>
                </div>
			<?php endif; ?>
            ...
            <div class="tf_form-row">
                ...
                <div class="tf-btn">
					<?php if ( ( $tf_booking_type == 2 && $tf_hide_booking_form !== '1' ) || $tf_booking_type == 1 ) : ?>
                        <?php if (!empty($apt_reserve_button_text)) : ?>
							<!-- <button class="" type="submit"><?php echo esc_html( $apt_reserve_button_text ); ?></button> -->
							<button id="bookingFormSubmit"><?php echo esc_html( $apt_reserve_button_text ); ?></button>
							<span class="errorText_form"></span>
						<?php endif; ?>
					<?php else: ?>
						<?php if (!empty($apt_reserve_button_text)) : ?>
							<a href="<?php echo esc_url( $tf_booking_url ); ?>"
                    ...
                    const bookingCalculation = (selectedDates) => {
                        ...
                        if (selectedDates[0] && selectedDates[1]) {
                            ...
                            if (days > 0) {
								...
								if (days >= 7) {
									// Check for "pool" in the URL
									if (currentUrl.includes("pool")) {
										var price_per_night = <?php echo esc_js( $price_per_night - 1000 ); ?>; // Pool discount
									} 
									// Check for "bedroom" in the URL
									else if (currentUrl.includes("bedroom")) {
										var price_per_night = <?php echo esc_js( $price_per_night - 1850 ); ?>; // 4 bedroom discount
									} 
									// Default case
									else {
										var price_per_night = <?php echo esc_js( $price_per_night ); ?>; // Default price
									}
								} 
								else {
									var price_per_night = <?php echo esc_js( $price_per_night ); ?>; // Default price
								};
								document.querySelector(".customPricing.villa .real .woocommerce-Price-amount.amount").innerText = `฿${new Intl.NumberFormat('en-US').format(price_per_night)}.00`;;
                                ...
                                if (enable_availability !== '1') {
                                    if (pricing_type === 'per_night') {
                                        ...
                                        $('.total-days-price-wrap .total-days').html(`฿${new Intl.NumberFormat('en-US').format(price_per_night)}.00` + ' x ' + days + ' <?php esc_html_e( 'nights', 'tourfic' ); ?>');
                                        ...
                                        $('.total-days-price-wrap .total-days').html(wc_price_per_person + ' x ' + days + ' <?php esc_html_e( 'nights2', 'tourfic' ); ?>');
                                        $('.total-days-price-wrap .days-total-price').html(total_days_price_html);
                                    }
                                } else {
                                    var total_price = 0;
